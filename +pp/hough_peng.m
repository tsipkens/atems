% HOUGH_PENG Detect circular shapes in a grayscale image. Resolve their center positions and radii.
% Originally called CIRCULARHOUGH_GRD.
% Used in the pp.altenhoff method, which has more standardized inputs.
% 
