...
Additional dependencies are required for use of the [carboseg](https://github.com/tsipkens/atems/tree/master/carboseg) component of this program, including a copy of Python. See the appropriate section [below](#+-carboseg-and-cnn-segmentation) for more information. 
